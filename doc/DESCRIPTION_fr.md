...
L'application vous permet aussi de gérer - si vous activez l'option - la gestion des erreurs 404, il vous suffit de créer un dossier `error` dans le répertoire racine `www`. 