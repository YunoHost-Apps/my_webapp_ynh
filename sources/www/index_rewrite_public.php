...
// Detect if we're in the public directory
$current_path = $_SERVER['SCRIPT_NAME'];
$is_public_dir = strpos($current_path, '/public/') !== false;
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="content">
            <div class="section">
                ...
                <div class="info-box">
                    ...
                    <ul>
                        ...
                        <li><strong>Enhanced Security</strong> - Code separation from public files</li>
                        <li><strong>Framework Ready</strong> - Perfect for Laravel, Symfony, etc.</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="section">
                ...
                <div class="code-block">
                    ...
                    ├── public/              # Public web files (this directory)<br>
                    │   ├── index.php       # Main entry point<br>
                    │   ├── .htaccess       # URL rewriting rules<br>
                    │   ├── assets/         # CSS, JS, images<br>
                    │   └── uploads/        # User uploads<br>
                    ├── app/                 # Application code<br>
                    ├── config/              # Configuration files<br>
                    ├── database/            # Database files<br>
                    ├── storage/             # Storage and logs<br>
                    └── vendor/              # Dependencies
                </div>

                <h3>Framework-Specific Setup</h3>
                <p>This mode is optimized for modern PHP frameworks. Here's how to set up popular ones:</p>
                
                <div class="info-box">
                    <h4>Laravel Setup:</h4>
                    <ul>
                        <li>Set document root to <code>/www/public/</code></li>
                        <li>Place Laravel files in <code>/www/</code></li>
                        <li>Configure <code>.env</code> file in <code>/www/</code></li>
                    </ul>
                </div>
                ...
                <div class="info-box">
                    ...
                    <ul>
                        <li>Set document root to <code>/www/public/</code></li>
                        <li>Place Symfony files in <code>/www/</code></li>
                        <li>Configure <code>config/</code> in <code>/www/</code></li>
                    </ul>
                </div>

                <h3>URL Routing</h3>
                <p>All URLs will be processed through your main <code>public/index.php</code> file, allowing you to create clean, SEO-friendly URLs:</p>
                ...
                <div class="info-box">
                    ...
                    <ul>
                        ...
                        <li><code>/assets/css/style.css</code> → serves static files</li>
                    </ul>
                </div>
            </div>
