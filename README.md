...
Custom Web app with SFTP access to serve static (HTML, CSS, JS) and PHP files. **Now supports 3 NGINX installation modes: Classic, Rewrite, and Rewrite-Public for modern web applications.**
